	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'pulse-subtle': 'pulse-subtle 2s infinite cubic-bezier(0.4, 0, 0.2, 1)',
				'float': 'float 3s infinite cubic-bezier(0.4, 0, 0.2, 1)',
				'vibrate': 'vibrate 1.5s infinite cubic-bezier(0.4, 0, 0.2, 1)',
