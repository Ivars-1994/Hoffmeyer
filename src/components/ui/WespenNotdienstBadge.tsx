...
const WespenNotdienstBadge = ({
  ...
  return (
    <div className={cn(
      'inline-flex items-center gap-2 px-4 py-2 rounded-full border-2 border-[#c9a227] bg-[#0B4D2F] text-[#c9a227] font-bold text-xs sm:text-sm shadow-lg',
      ...
      <span className="bg-[#c9a227] text-[#0B4D2F] px-2 py-0.5 rounded-full text-[10px] sm:text-xs font-bold">
        24/7
      </span>
    </div>
  );
