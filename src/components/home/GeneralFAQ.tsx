  ...
  const faqs = [
    {
      ...
      answer: `Die Kosten für einen Kammerjäger in ${city} variieren je nach Schädlingsart und Befallsgrad. Bei Kammerjäger Löwenstein bieten wir transparente Preise und kostenlose Anfahrt. Kontaktieren Sie uns für ein unverbindliches Angebot.`
    },
    {
      question: `Wie schnell kommt der Kammerjäger in ${city}?`,
      answer: `Kammerjäger Löwenstein bietet einen 24/7 Notdienst in ${city}. In dringenden Fällen sind wir innerhalb von 30-60 Minuten vor Ort. Bei regulären Anfragen vereinbaren wir kurzfristige Termine nach Ihren Wünschen.`
    },
    {
    ...
    },
    {
      ...
      answer: `Nein, unsere Marder-Abwehr ist tierschonend. Wir setzen auf Vergrämungsmittel und professionelle Abdichtung Ihres Dachbodens. Kammerjäger Löwenstein arbeitet nach den neuesten tierschutzrechtlichen Standards.`
    },
    {
    ...
    },
    {
      ...
      answer: `Ja, alle von Kammerjäger Löwenstein verwendeten Mittel sind zugelassen und für Menschen sowie Haustiere unbedenklich bei sachgemäßer Anwendung. Wir halten uns streng an gesetzliche Vorgaben und informieren Sie detailliert über alle Maßnahmen.`
    }
  ];
