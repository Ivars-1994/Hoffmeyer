...
const HartmannContact = () => {
  ...
  return (
    <section id="kontakt" className="bg-[#064A2A] py-16 px-4 md:px-8">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-4 bg-[#c9a227] text-[#064A2A] px-10 py-6 rounded-2xl font-bold text-2xl md:text-3xl hover:bg-[#d4b13a] transition-all shadow-2xl hover:scale-[1.03]"
        >
