...
const Einsatzgebiet = () => {
  ...
  return (
    <section ref={rootRef} className="bg-[#0B4D2F] py-16 px-4 md:px-8 border-t border-[#c9a227]/20">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <a
            href={CALL}
            className="inline-flex items-center gap-3 bg-[#c9a227] text-[#0B4D2F] font-bold px-6 py-4 rounded-lg hover:bg-[#b8931f] transition-colors shadow-lg"
            onClick={() => {
        ...
        <div className="bg-[#004422]/60 border border-[#c9a227]/30 rounded-xl p-6 md:p-8">
          ...
          {(state === 'error' || (state === 'idle' && !hasCity)) && (
            <div>
              ...
              <a
                href={CALL}
                className="inline-flex items-center gap-2 bg-[#c9a227] text-[#0B4D2F] font-bold px-5 py-3 rounded-lg hover:bg-[#b8931f] transition-colors"
              >
                <Phone className="w-5 h-5" />
                Jetzt anrufen · {PHONE_DISPLAY}
              </a>
