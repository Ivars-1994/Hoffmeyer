...
const HartmannProcess = () => {
  return (
    <section className="bg-[#0B4D2F] py-16 px-4 md:px-8">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={index} className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 bg-[#0B4D2F] border-2 border-[#c9a227] rounded-full flex items-center justify-center">
