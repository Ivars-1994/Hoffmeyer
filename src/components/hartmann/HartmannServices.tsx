...
const services: { title: string; description: string; icon: ReactNode }[] = [
  {
    ...
    icon: (
      <svg className="w-14 h-14" viewBox="0 0 64 64" fill="none" stroke="#064A2A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-14 h-14" viewBox="0 0 64 64" fill="none" stroke="#064A2A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M48 30l8 2" />
        <circle cx="40" cy="28" r="2" fill="#064A2A" />
  ...
  },
  {
    ...
    icon: (
      <svg className="w-14 h-14" viewBox="0 0 64 64" fill="none" stroke="#064A2A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <circle cx="36" cy="30" r="1.5" fill="#064A2A" />
  ...
  },
  {
    ...
    icon: (
      <svg className="w-14 h-14" viewBox="0 0 64 64" fill="none" stroke="#064A2A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <circle cx="38" cy="28" r="1.5" fill="#064A2A" />
        <path d="M42 32l4 1" />
...
const HartmannServices = () => {
  return (
    <section id="leistungen" className="bg-[#064A2A] py-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        {/* First row header */}
        <div className="text-center mb-8">
          <div className="inline-block bg-[#c9a227] text-[#064A2A] px-6 py-2 rounded-lg font-bold text-sm mb-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">Mo. - Fr.</p>
        </div>
