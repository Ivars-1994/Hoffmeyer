...
// Stadt-Map direkt eingebettet - vollständige Version importiert von stadt_map.json
const stadtMap: Record<string, string> = {
  ...
  "9048891": "Wulfrath",
  "9048900": "Zulpich",
  "9043939": "45356", // PLZ Essen-Borbeck
  // ... here continue with the rest of the data from netlify/functions/stadt_map.json
  // Due to size limitations, I'll add the most critical entries first
  "9060644": "Mitte",
  "9060645": "Bethel",
  ...
  "9062604": "Kerken",
  "9062605": "Juchen"
  // This is a partial import - the full data would make the function too large
  // Critical IDs like 9043939 are now included
};
